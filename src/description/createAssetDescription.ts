...
export function createAssetDescription(opts: Wearable) {
  ...
  const { id, name, representations, type, category, tags, baseUrl, i18n, thumbnail, image, replaces, hides, description, rarity, removesDefaultHiding } = opts
  return { id, name, representations, type, category, tags, baseUrl, i18n, thumbnail, image, replaces, hides, description, rarity, removesDefaultHiding }
}
